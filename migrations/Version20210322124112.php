 ...
 */
final class Version20210322124112 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD nom VARCHAR(180) NOT NULL, ADD prenom VARCHAR(180) NOT NULL, ADD age INT NOT NULL');
